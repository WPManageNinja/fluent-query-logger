...
class WPDBConnection implements ConnectionInterface
{
     ...
     * Return self as PDO
     *
     * @return FluentQueryLogger\Framework\Database\Database
     */
