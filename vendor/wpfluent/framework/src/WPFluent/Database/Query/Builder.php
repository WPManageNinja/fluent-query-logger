...
namespace FluentQueryLogger\Framework\Database\Query;
...
use FluentQueryLogger\Framework\Support\Collection;
...
use FluentQueryLogger\Framework\Database\Query\Grammar;
use FluentQueryLogger\Framework\Database\Query\Processor;
use FluentQueryLogger\Framework\Support\ArrayableInterface;
use FluentQueryLogger\Framework\Database\ConnectionInterface;
...
class Builder
{
     ...
     *
     * @var \FluentQueryLogger\Framework\Database\Query\WPDBConnection
     */
     ...
     *
     * @var \FluentQueryLogger\Framework\Database\Query\Grammar
     */
    protected $grammar;
     ...
     *
     * @var \FluentQueryLogger\Framework\Database\Query\Processor
     */
    protected $processor;
     ...
     *
     * @param  \FluentQueryLogger\Framework\Database\ConnectionInterface  $connection
     * @param  \FluentQueryLogger\Framework\Database\Query\Grammar  $grammar
     * @param  \FluentQueryLogger\Framework\Database\Query\Processor  $processor
     * @return void
     */
     ...
     * @return \FluentQueryLogger\Framework\Database\Query\Builder|static
     */
     ...
     *
     * @param  \Closure|\FluentQueryLogger\Framework\Database\Query\Builder|string $query
     * @param  string  $as
     * @return \FluentQueryLogger\Framework\Database\Query\Builder|static
     *
     ...
     *
     * @param  \FluentQueryLogger\Framework\Database\Query\Builder|static $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \FluentQueryLogger\Framework\Database\Query\Builder|\Closure  $query
     * @param  bool  $all
     * @return \FluentQueryLogger\Framework\Database\Query\Builder|static
     */
     ...
     * @param  int|null  $page
     * @return \FluentQueryLogger\Framework\Pagination\LengthAwarePaginatorInterface
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \FluentQueryLogger\Framework\Pagination\PaginatorInterface
     */
     ...
     *
     * @param  mixed  $value
     * @return \FluentQueryLogger\Framework\Database\Query\Expression
     */
     ...
     *
     * @return \FluentQueryLogger\Framework\Database\Query\Processor
     */
     ...
     *
     * @return \FluentQueryLogger\Framework\Database\Query\Grammar
     */
