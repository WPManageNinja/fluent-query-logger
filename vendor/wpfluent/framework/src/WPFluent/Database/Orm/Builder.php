...
use FluentQueryLogger\Framework\Pagination\Paginator;
use FluentQueryLogger\Framework\Database\Query\Expression;
use FluentQueryLogger\Framework\Pagination\LengthAwarePaginator;
...
class Builder
{
     ...
     *
     * @var \FluentQueryLogger\Framework\Database\Query\Builder
     */
    protected $query;
     ...
     *
     * @var \FluentQueryLogger\Framework\Database\Orm\Model
     */
    protected $model;
     ...
     * @param  \FluentQueryLogger\Framework\Database\Orm\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  \FluentQueryLogger\Framework\Database\Orm\Scope|string  $scope
     * @return $this
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentQueryLogger\Framework\Database\Orm\Model|\FluentQueryLogger\Framework\Database\Orm\Collection|static[]|static|null
     */
     ...
     *
     * @param  array  $columns
     * @return \FluentQueryLogger\Framework\Database\Orm\Model|static|null
     */
     ...
     *
     * @param  array  $columns
     * @return \FluentQueryLogger\Framework\Database\Orm\Collection|static[]
     */
     ...
     *
     * @param  string  $name
     * @return \FluentQueryLogger\Framework\Database\Orm\Relations\Relation
     */
     ...
     * @param  string  $operator
     * @param  mixed   $value
     * @return \FluentQueryLogger\Framework\Database\Orm\Builder|static
     */
     ...
     *
     * @param  \FluentQueryLogger\Framework\Database\Orm\Builder  $hasQuery
     * @param  \FluentQueryLogger\Framework\Database\Orm\Relations\Relation  $relation
     * @param  string  $operator
     * @param  int  $count
     * @param  string  $boolean
     * @return \FluentQueryLogger\Framework\Database\Orm\Builder|static
     ...
     *
     * @param  \FluentQueryLogger\Framework\Database\Orm\Builder  $relation
     * @return \FluentQueryLogger\Framework\Database\Orm\Builder|static
     */
