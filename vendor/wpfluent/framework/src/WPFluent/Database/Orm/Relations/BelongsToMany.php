...
namespace FluentQueryLogger\Framework\Database\Orm\Relations;
...
use FluentQueryLogger\Framework\Database\Orm\Builder;
use FluentQueryLogger\Framework\Database\Orm\Collection;
use FluentQueryLogger\Framework\Database\Orm\ModelHelperTrait;
use FluentQueryLogger\Framework\Database\Orm\ModelNotFoundException;
...
class BelongsToMany extends Relation
{
     ...
     *
     * @param  \FluentQueryLogger\Framework\Database\Orm\Builder  $query
     * @param  \FluentQueryLogger\Framework\Database\Orm\Model  $parent
     * @param  string  $table
     ...
     * @return \FluentQueryLogger\Framework\Database\Orm\Relations\BelongsToMany
     */
     ...
     *
     * @param  array  $columns
     * @return \FluentQueryLogger\Framework\Database\Orm\Model|static
     *
     * @throws \FluentQueryLogger\Framework\Database\Orm\ModelNotFoundException
     */
     ...
     *
     * @param  array  $columns
     * @return \FluentQueryLogger\Framework\Database\Orm\Collection
     */
     ...
     * @param  int|null  $page
     * @return \FluentQueryLogger\Framework\Contracts\Pagination\LengthAwarePaginator
     */
     ...
     * @param  array  $columns
     * @param  string  $pageName
     * @return \FluentQueryLogger\Framework\Contracts\Pagination\Paginator
     */
     ...
     *
     * @param  \FluentQueryLogger\Framework\Database\Orm\Builder  $query
     * @param  \FluentQueryLogger\Framework\Database\Orm\Builder  $parent
     * @param  array|mixed  $columns
     * @return \FluentQueryLogger\Framework\Database\Orm\Builder
     */
     ...
     *
     * @param  \FluentQueryLogger\Framework\Database\Orm\Builder|null  $query
     * @return $this
     */
     ...
     *
     * @param  array   $models
     * @param  \FluentQueryLogger\Framework\Database\Orm\Collection  $results
     * @param  string  $relation
     * @return array
     */
     ...
     *
     * @return \FluentQueryLogger\Framework\Support\Collection
     */
     ...
     * @param  array  $joining
     * @param  bool   $touch
     * @return \FluentQueryLogger\Framework\Database\Orm\Model
     */
     ...
     *
     * @param  \FluentQueryLogger\Framework\Support\Collection|array  $models
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentQueryLogger\Framework\Database\Orm\Model|\FluentQueryLogger\Framework\Database\Orm\Collection|null
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentQueryLogger\Framework\Database\Orm\Model|\FluentQueryLogger\Framework\Database\Orm\Collection
     *
     * @throws \FluentQueryLogger\Framework\Database\Orm\ModelNotFoundException
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentQueryLogger\Framework\Support\Collection|\FluentQueryLogger\Framework\Database\Orm\Model
     */
     ...
     *
     * @param  \FluentQueryLogger\Framework\Database\Orm\Collection|array  $ids
     * @return array
     */
     ...
     * @param  array  $attributes
     * @param  bool   $exists
     * @return \FluentQueryLogger\Framework\Database\Orm\Relations\Pivot
     */
